...
protected:
	...
	std::vector<std::shared_ptr<Enemy>>* enemiesPtr = nullptr; // 敌人的指针列表
...
public:
	...
	void handleObstacleCollisions(const std::vector<Obstacle>& obstacles);
	void handleGoalAndItemCollisions(Goal& goal, std::vector<BoostItem>& boostItems);
